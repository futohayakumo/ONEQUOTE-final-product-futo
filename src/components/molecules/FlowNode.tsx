...
const ICON: Record<NodeId, React.ComponentType<{ size?: number }>> = {
  "web-app": WindowIcon,
  "node-gateway": RouteIcon,
  "feature-flags": FlagIcon,
  translation: LanguageIcon,
  booking: BoxIcon,
  oog: CubeOutlineIcon,
  premium: CheckCircleIcon,
  "osl-plus": ClipboardIcon,
  dnd: ContainerIcon,
  pudo: GridIcon,
  campaigns: MegaphoneIcon,
  coupons: BarsIcon,
  "price-alerts": BellIcon,
  "notify-me": MailIcon,
  "missing-route": GlobeIcon,
  apigee: ServerIcon,
  schedule: ShipIcon,
  space: ContainerIcon,
  "rate-engine": BarsIcon,
  "opus-booking": DatabaseIcon,
